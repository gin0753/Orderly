...
export function ProductModal({ product, onClose }: ProductModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-end justify-center bg-black/40 px-4 py-6 backdrop-blur-sm md:items-center">
      ...
      <div className="relative z-10 flex max-h-[90vh] w-full max-w-3xl flex-col overflow-hidden rounded-3xl bg-white shadow-2xl md:grid md:grid-cols-[1fr_1.05fr]">
        ...
        <div className="overflow-y-auto p-6 md:p-8">
          ...
          <div className="mt-6 border-t border-neutral-100 pt-5">
            <h3 className="text-sm font-semibold text-neutral-950">Quantity</h3>
          ...
          <button
            ...
            className="mt-8 flex w-full items-center justify-center rounded-2xl bg-[#ff4d00] px-5 py-4 text-sm font-semibold text-white shadow-sm transition hover:bg-orange-600"
          >
            Add to cart
